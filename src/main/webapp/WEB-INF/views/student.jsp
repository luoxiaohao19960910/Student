	...
	<body class="layui-layout-body">
		<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-header" style="position: relative; color: white;">
				<div class="layui-logo" style="color: white;">学 生 基 本 信 息</div>
				<h1 style="text-align: center; line-height: 60px;">电&nbsp;&nbsp;气&nbsp;&nbsp;信&nbsp;&nbsp;息&nbsp;&nbsp;系&nbsp;&nbsp;学&nbsp;&nbsp;生&nbsp;&nbsp;成&nbsp;&nbsp;绩&nbsp;&nbsp;查&nbsp;&nbsp;分&nbsp;&nbsp;系&nbsp;&nbsp;统</h1>
	
				<div style="position: absolute; right: 40px; top: 16px;">
					 <i class="iconfont icon-xuesheng" style="position: absolute; right: 70px; top: -5px;font-size: 40px;"></i>&nbsp;<span style="position: absolute; right: 5px; top: 2px;font-size: 20px;width: 60px">${studentInfo.studentName}</span>
					 <c:if test="${studentInfo.studentSex == '男'}">
						<i class="iconfont icon-nan" style="position: absolute; right: -40px; top: -5px;font-size: 40px;color:#87CEFF"></i>
					</c:if>
					<c:if test="${studentInfo.studentSex == '女'}">
				...
				<div class="layui-side-scroll">
					...
					<ul class="layui-nav layui-nav-tree" lay-filter="test">
						...
						<li class="layui-nav-item" style="position: relative;"><a
							class="" href="javascript:;" onclick="selectedCourses()" style="font-size: 16px;">已选课程<i
								class="iconfont icon-shuben"
								style="position: absolute; left: 145px; top: -1px; font-size: 25px;"></i>
						</a></li>
						<br>
						<li class="layui-nav-item" style="position: relative;"><a
							class="" href="javascript:;" onclick="allCourses()" style="font-size: 16px;">可选课程 <i
								class="iconfont icon-shuben1"
								style="position: absolute; left: 145px; top: -1px; font-size: 25px;"></i>
						</a></li>
						<br>
						<li class="layui-nav-item" style="position: relative;"><a
							class="" href="javascript:;" onclick="finishedCourses()" style="font-size: 16px;">已修课程 <i
								class="iconfont icon-shubenhoushu"
								style="position: absolute; left: 145px; top: -1px; font-size: 25px;"></i>
						</a></li>
						<br>
						<li class="layui-nav-item" style="position: relative;"><a
							href="javascript:;" onclick="updatePassword()" style="font-size: 16px;">修改密码 <i
		...
		<script>
			...
			function allCourses(){
				$("#link").attr("href",'${pageContext.request.contextPath}/courses.jsp?studentId=${studentInfo.studentId}');
				$("#auto").trigger("click");
			}
			
			function selectedCourses(){
				$("#link").attr("href",'${pageContext.request.contextPath}/selectedCourses.jsp?studentId=${studentInfo.studentId}');
				$("#auto").trigger("click");
			}
			
			function finishedCourses(){
				$("#link").attr("href",'${pageContext.request.contextPath}/finishedCourses.jsp?studentId=${studentInfo.studentId}');
				$("#auto").trigger("click");
			}
			
			function updatePassword(){
				$("#link").attr("href",'${pageContext.request.contextPath}/updateStudentPassword.jsp?studentId=${studentInfo.studentId}');
				$("#auto").trigger("click");
			}
